...
class Redux_Welcome {
	...
	public function actions() {
		...
		<p class="redux-actions">
			...
			<a href="<?php echo 'http://'; ?>wordpress.org/plugins/redux-framework/"
			...
			<a href="<?php echo 'https://'; ?>twitter.com/share" class="twitter-share-button"
	...
	public function contributors() {
		...
		foreach ( $contributors as $contributor ) {
			...
			$contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( esc_html__( 'View %s', 'redux-framework' ), $contributor->login ) )
			);
