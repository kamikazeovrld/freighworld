<div class="wrap about-wrap">
	<h1><?php printf( esc_html__( 'Welcome to Redux Framework %s', 'redux-framework' ), $this->display_version ); ?></h1>
	<div
		class="about-text"><?php printf( esc_html__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'redux-framework' ), $this->display_version ); ?></div>
	<div
		class="redux-badge"><i
				...
				<div>
					...
					<p>This version the fastest Redux ever released. We've integrated ajax_saving as well as many other
						speed improvements to make Redux even surpass the load time of <a
							href="<?php echo 'https://'; ?>github.com/syamilmj/Options-Framework"
							target="_blank">SMOF</a> even with
						large panels.</p>
				</div>
				<div>
					...
					<p>We've gone back to the drawing boards and made Redux the <strong>simplest</strong> framework to
						...
						having to define a class! <a
							href="<?php echo 'http://'; ?>docs.reduxframework.com/core/redux-api/" target="_blank">Learn
							More</a></p>
				</div>
				<div class="last-feature">
					<h4>Security Improvments</h4>
					<p>Thanks to the help of <a href="<?php echo 'http://'; ?>www.pritect.net/" target="_blank">James
							Golovich
			...
			<div class="feature-section col three-col">
				<div>
					...
					<p>Now developers can easily customize the Redux panel by declaring a templates location path. We've
						also made use of template versioning so if we change anything, you will know. <br/><a
							href="<?php echo 'http://'; ?>docs.reduxframework.com/core/templates/" target="_blank">Learn
							More</a></p>
				</div>
				<div>
