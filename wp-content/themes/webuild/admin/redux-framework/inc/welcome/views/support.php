...
<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
	...
	<div
		class="about-text"><?php printf( esc_html__( 'We are an open source project used by developers to make powerful control panels.', 'redux-framework' ), $this->display_version ); ?></div>
	<div
		class="redux-badge"><i
