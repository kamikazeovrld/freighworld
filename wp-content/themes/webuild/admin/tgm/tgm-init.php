...
add_action( 'tgmpa_register', 'apro_register_required_plugins' );
/**
 ...
 */
function apro_register_required_plugins() {
	/**
	...
	$plugins = array(
		...
		array(
			...
			'source'   => get_template_directory() . '/admin/tgm/plugins/Ultimate_VC_Addons.zip',
			'required' => true,
		),
		array(
			'name'     => 'Revolution Slider',
			'slug'     => 'revslider',
			'source'   => get_template_directory() . '/admin/tgm/plugins/revslider.zip',
			'required' => true,
		),
		array(
			'name'     => 'Essential Grid',
			'slug'     => 'essential-grid',
			'source'   => get_template_directory() . '/admin/tgm/plugins/essential-grid.zip',
			'required' => true,
		),
