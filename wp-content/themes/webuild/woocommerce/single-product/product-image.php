...
<div class="pro-single-images images">
	...
	if ( has_post_thumbnail() ) {
		...
		echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="woocommerce-main-image zoom fancybox-thumb" title="%s" data-fancybox-group="gallery' . $gallery . '">%s</a>', $image_link, $image_title, $image ), $post->ID );
	} else {
