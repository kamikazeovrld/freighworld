...
class PRO_WC_Product_Cat_List_Walker extends Walker {
	...
	public function start_el( &$output, $cat, $depth = 0, $args = array(), $current_object_id = 0 ) {
		if ( $args['display_image'] ) {
			...
			$image = wp_get_attachment_image( $thumbnail_id, array( 32, 32 ) );// get image and convert to var
		}
		...
		$output .= esc_html__( '' . $cat->name, 'woocommerce' ) . '</a>';
		if ( $args['show_count'] ) {
