...
/**
 *
 * WeBuild Theme Updater
 *
 * @since 1.0.0
 * @version 1.0.0
 *
 */
if ( ! function_exists( 'webuild_pre_set_site_transient_update_themes' ) ) {
	function webuild_pre_set_site_transient_update_themes( $updates ) {
	...
	add_filter( 'pre_set_site_transient_update_themes', 'webuild_pre_set_site_transient_update_themes' );
}
if ( ! function_exists( 'webuild_admin_head' ) ) {
	function webuild_admin_head() {
		global $pagenow;
	...
	add_action( 'admin_head', 'webuild_admin_head' );
}