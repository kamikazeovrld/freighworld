...
/**
 *
 * PROFramework Shortcodes API
 * @since 1.0.0
 * @version 1.0.0
 *
 */
class PROFramework_Shortcodes_API extends PROFramework_Abstract {
	...
	public function media_shortcode_button( $editor_id = 'content' ) {
		echo '<a href="#" onmousedown="return false;" class="button button-primary shortcode-button" data-editor="' . esc_attr( $editor_id ) . '"><span class="dashicons dashicons-menu"></span> Add Shortcode</a>';
	}
	...
	public function shortcode_dialog() {
		...
		<div id="shortcode-dialog" title="Shortcode Manager">
			<div id="dialog-header-wrap">
				<select id="shortcode-select" class="chosen" data-placeholder="Select a shortcode">
					<option value=""></option>
					<?php
