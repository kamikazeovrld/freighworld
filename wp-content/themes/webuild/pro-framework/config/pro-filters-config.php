...
if ( ! function_exists( 'webuild_excerpt_read_more_link' ) ) {
	function webuild_excerpt_read_more_link( $text ) {
		return ( is_search() ) ? $text : $text . '<a href="' . esc_url(get_permalink( get_the_ID() )) . '" class="entry-more pro-btn pro-btn-rounded pro-btn-xxs pro-btn-flat-accent">' . esc_html__( 'Read More', THEME_NAME ) . '<span class="screen-reader-text"> '.esc_html__( 'about', THEME_NAME ).' '. get_the_title() .'</span></a>';
	}
...
if ( ! function_exists( 'sin_excerpt' ) ) {
	function sin_excerpt($limit)
	{
		...
		$excerpt .= '<a href="' . esc_url(get_permalink(get_the_ID())) . '" class="entry-more pro-btn pro-btn-rounded pro-btn-xxs pro-btn-flat-accent">' . esc_html__('Read More', THEME_NAME ) . '<span class="screen-reader-text"> ' . esc_html__('about', THEME_NAME ) . ' ' . get_the_title() . '</span></a>';
		return $excerpt;
	}
}
}